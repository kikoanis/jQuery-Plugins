...
(function ($) {
    ...
    */
    $.fn.numeric = function (config, callback) {
        ...
        // callback function
        var callback1 = typeof callback == "function" ? callback : function () { };
    ...
    function isHotKey(e) {
        ...
        // allow Tab
        if ((key == 9 /* firefox */) || (key == 9) /* opera */) return true;
        // allow Shift+Tab
        if ((e.shiftKey && key == 9 /* firefox */) || (e.shiftKey && key == 9) /* opera */) return true;
        // allow shift only
        if (key == 16) return true;
        // allow ctrl key
        if (key == 17) return true;
        // allow alt key
        if (key == 18) return true;
        // allow Ctrl+X (cut)
    ...
    $.fn.numeric.keyup = function (e) {
        ...
        if (val.length > 0) {
            ...
            if (firstDecimal > 0) {
                for (i = length - 1; i > firstDecimal; i--) {
                    ch = val.charAt(i);
